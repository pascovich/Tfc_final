				...
				<div class="dropdown">
					...
					<?php foreach($don as $connecte):  ?>
						<span class="user-icon">
							...
							<img src="../media/images/<?=$connecte->photo;?>" width="80%" alt="image">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="profile_etudiant.php"><i class="dw dw-user1"></i> Profile</a>
