...
if (isset($_POST["action"])) {
	...
	if ($_POST["action"] == 'Add') {
		...
		// $statement = $db->prepare("INSERT INTO department_table (department_name, department_contact_person, department_created_on) 
		// VALUES (:department_name, :department_contact_person");
		// $result = $statement->execute(
		// 	array(
		// 		':department_name'	=>	$_POST["department_name"],
		// 		':department_contact_person'	=>	$_POST["department_contact_person"]
		// 		// ':department_created_on'	=>	$_POST["department_created_on"],
		// 	)
		// );
		// if(!empty($result))
		// {
